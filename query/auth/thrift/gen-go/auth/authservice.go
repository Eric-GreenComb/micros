...
func NewAuthServiceProcessor(handler AuthService) *AuthServiceProcessor {
	...
	self2 := &AuthServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["Login"] = &authServiceProcessorLogin{handler: handler}
	return self2
}
