...
func (p *WorkHistoryServiceClient) sendGetWorkHistory(profile_id string) (err error) {
	...
	p.SeqId++
	if err = oprot.WriteMessageBegin("GetWorkHistory", thrift.CALL, p.SeqId); err != nil {
		return
	}
...
func (p *WorkHistoryServiceClient) recvGetWorkHistory() (value string, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
	...
	if method != "GetWorkHistory" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "GetWorkHistory failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
		err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "GetWorkHistory failed: out of sequence response")
		return
	}
	if mTypeId == thrift.EXCEPTION {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "GetWorkHistory failed: invalid message type")
		return
	}
	result := WorkHistoryServiceGetWorkHistoryResult{}
	if err = result.Read(iprot); err != nil {
		return
	}
	if err = iprot.ReadMessageEnd(); err != nil {
...
func NewWorkHistoryServiceProcessor(handler WorkHistoryService) *WorkHistoryServiceProcessor {
	...
	self4.processorMap["GetWorkHistory"] = &workHistoryServiceProcessorGetWorkHistory{handler: handler}
	return self4
}
...
type workHistoryServiceProcessorGetWorkHistory struct {
	handler WorkHistoryService
}

func (p *workHistoryServiceProcessorGetWorkHistory) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := WorkHistoryServiceGetWorkHistoryArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetWorkHistory", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
		return false, err
	...
	var retval string
	var err2 error
	if retval, err2 = p.handler.GetWorkHistory(args.ProfileID); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetWorkHistory: "+err2.Error())
		oprot.WriteMessageBegin("GetWorkHistory", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
	...
	if err2 = oprot.WriteMessageBegin("GetWorkHistory", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func NewWorkHistoryServiceGetWorkHistoryArgs() *WorkHistoryServiceGetWorkHistoryArgs {
	return &WorkHistoryServiceGetWorkHistoryArgs{}
}

func (p *WorkHistoryServiceGetWorkHistoryArgs) GetProfileID() string {
	return p.ProfileID
}
func (p *WorkHistoryServiceGetWorkHistoryArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *WorkHistoryServiceGetWorkHistoryArgs) readField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
...
func (p *WorkHistoryServiceGetWorkHistoryArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("GetWorkHistory_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
...
func (p *WorkHistoryServiceGetWorkHistoryArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("WorkHistoryServiceGetWorkHistoryArgs(%+v)", *p)
}

// Attributes:
//  - Success
type WorkHistoryServiceGetWorkHistoryResult struct {
	Success *string `thrift:"success,0" json:"success,omitempty"`
}

func NewWorkHistoryServiceGetWorkHistoryResult() *WorkHistoryServiceGetWorkHistoryResult {
	return &WorkHistoryServiceGetWorkHistoryResult{}
}

var WorkHistoryServiceGetWorkHistoryResult_Success_DEFAULT string

func (p *WorkHistoryServiceGetWorkHistoryResult) GetSuccess() string {
	if !p.IsSetSuccess() {
		return WorkHistoryServiceGetWorkHistoryResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *WorkHistoryServiceGetWorkHistoryResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *WorkHistoryServiceGetWorkHistoryResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *WorkHistoryServiceGetWorkHistoryResult) readField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 0: ", err)
	} else {
		p.Success = &v
...
func (p *WorkHistoryServiceGetWorkHistoryResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("GetWorkHistory_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField0(oprot); err != nil {
		return err
...
func (p *WorkHistoryServiceGetWorkHistoryResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRING, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *WorkHistoryServiceGetWorkHistoryResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("WorkHistoryServiceGetWorkHistoryResult(%+v)", *p)
}
