...
func main() {
	var (
		thriftAddr       = flag.String("thrift.addr", "localhost:39070", "Address for Thrift server")
	...
	case "get":
		v := svc.GetResume("5707cb10ae6faa1d1071a189")
		logger.Log("method", "GetResume", "v", v, "took", time.Since(begin))
