...
func NewTokenServiceProcessor(handler TokenService) *TokenServiceProcessor {
	...
	self2 := &TokenServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["VerifyToken"] = &tokenServiceProcessorVerifyToken{handler: handler}
	return self2
}
