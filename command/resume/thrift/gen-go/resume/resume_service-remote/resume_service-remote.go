...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string UpdateResumeSkillExperience(string userid, string experienceLevels)")
	fmt.Fprintln(os.Stderr, "  string UpdateResumeToolandArchs(string userid, string toolArchs)")
	fmt.Fprintln(os.Stderr, "  string UpdateResumePortfolioes(string userid, string portfolioes)")
	fmt.Fprintln(os.Stderr, "  string UpdateResumeEmploymentHistories(string userid, string employmentHistories)")
	fmt.Fprintln(os.Stderr, "  string UpdateResumeEducations(string userid, string educations)")
	fmt.Fprintln(os.Stderr, "  string UpdateResumeOtherExperiences(string userid, string otherExperiences)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
