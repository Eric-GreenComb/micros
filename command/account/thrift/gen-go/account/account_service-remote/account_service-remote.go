...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string CreateAccount(string json_account)")
	fmt.Fprintln(os.Stderr, "  string CreateBilling(string json_billing)")
	fmt.Fprintln(os.Stderr, "  string DealBilling(string billing_id)")
	fmt.Fprintln(os.Stderr, "  string CancelBilling(string billing_id)")
	fmt.Fprintln(os.Stderr, "  string GenAccount(string user_id)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
