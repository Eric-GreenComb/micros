...
// TokenCollection User表的Collection对象
...
func main() {
	...
	var (
		thriftAddr       = fs.String("thrift.addr", ":36040", "Address for Thrift server")
	...
	client := etcd.ReigistryClient{
		etcd.RegistryConfig{
			ServiceName:  banerwaiglobal.EtcdKeyMicrosCommandToken,
