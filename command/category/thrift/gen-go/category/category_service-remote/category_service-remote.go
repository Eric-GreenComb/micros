...
import (
	...
	"github.com/banerwai/micros/command/category/thrift/gen-go/category"
	"math"
	"net"
	"net/url"
	"os"
...
func main() {
	...
	client := category.NewCategoryServiceClientFactory(trans, protocolFactory)
	...
	case "LoadCategory":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.LoadCategory(value0))
		fmt.Print("\n")
		break
	case "GetCategories":
		if flag.NArg()-1 != 0 {
		...
		fmt.Print(client.GetCategories())
		fmt.Print("\n")
		break
